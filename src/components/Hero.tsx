...
const Hero = () => {
  ...
  return (
    <section 
      id="home" 
      ref={containerRef}
      className="relative min-h-screen pt-20 flex flex-col justify-center items-center overflow-hidden"
    >
      ...
      <div className="container px-4 max-w-6xl mx-auto rounded-3xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className={cn(
            "space-y-8 text-center lg:text-left transition-all duration-1000 transform",
            ...
            <div className="space-y-2">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight animate-fade-in animate-delay-100">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mt-4 max-w-lg mx-auto lg:mx-0 animate-fade-in animate-delay-200">
                Creating meaningful and performant web applications with a focus on user experience and accessibility.
              </p>
            </div>
            
            <div className="h-6 font-mono text-sm md:text-base animate-fade-in animate-delay-400">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-fade-in animate-delay-500">
              <Button
                asChild
                className="btn-hover btn-shimmer px-6 py-6 h-auto rounded-full text-sm 
              ...
              <Button
                asChild
                variant="outline"
                className="btn-hover px-6 py-6 h-auto rounded-full text-sm font-medium 
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a 
          href="#about" 
          className="flex items-center justify-center w-12 h-12 rounded-full glass hover:bg-white/20 transition-all duration-300 pulse-glow"
