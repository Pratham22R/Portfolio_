...
const Footer = () => {
  ...
  const linkClass =
    "hover:text-blue-500 transition-colors duration-300 inline-block relative after:absolute after:w-0 after:h-0.5 after:bg-gradient-to-r after:from-blue-500 after:to-purple-600 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300";
  ...
  return (
    <footer id="contact" className="py-16 relative overflow-hidden">
      ...
      >
        <div className="glass-card p-8 md:p-12 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-500">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Left Section */}
            <div>
              <h2 className="text-2xl font-bold mb-4 gradient-text">Let's Work Together</h2>
              <p className="text-muted-foreground mb-6 hover:text-muted-foreground/80 transition-colors duration-300">
              ...
              <div className="mb-8">
                <a
                  ...
                  className="text-lg font-medium hover:text-blue-500 transition-colors inline-block relative"
                >
